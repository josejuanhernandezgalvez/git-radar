...
import metrics.counters.IdentationMetric;
import org.junit.Test;

import static org.junit.Assert.assertEquals;

public class IdentationMetric_ {
    @Test
    public void getIdentationTest() {
        String code = "class DataAnalyzer:\n" +
                ...
                "\n" +
                "        return self.output";
        int expectedIdentation = 3;
        IdentationMetric identationMetric = new IdentationMetric();
        int identationLevel = identationMetric.calculateMaxIdentation(code);
        assertEquals(identationLevel, expectedIdentation);
    }
}
